  ...
  return (
    <div className="fixed inset-0 overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex flex-col h-full">
        <header className="flex-1 flex flex-col items-center justify-center px-8 pt-12 pb-8">
          <div className="text-center space-y-6 animate-fadeInUp">
            <div className="relative">
              <h1
                className="title-retro text-7xl md:text-9xl font-black tracking-tighter text-white text-shadow-glow"
                data-text="POKÉMON"
              >
                POKÉMON
              </h1>
            ...
            <p className="mt-6 text-sm md:text-base text-gray-400 max-w-2xl leading-relaxed font-light tracking-wide">
            ...
            {[...pokemons, ...pokemons, ...pokemons].map((pokemon, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-2 text-[10px] font-mono text-white/60 tracking-widest uppercase">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-3 group">
        <Link to="/list">
          <div className="relative w-32 h-32 md:w-40 md:h-40 group-hover:scale-110 transition-transform duration-500">
            <svg
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="relative">
                <div className="absolute inset-0 w-20 h-20 md:w-24 md:h-24 border-2 border-white/30 rounded-full animate-borderGlow"></div>

                <div className="relative bg-white text-black w-20 h-20 md:w-24 md:h-24 rounded-full flex items-center justify-center shadow-2xl hover:bg-gray-900 hover:text-white transition-all duration-300 border-4 border-white/20">
                  <svg
                    className="w-14 h-14 md:w-16 md:h-16 text-current"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                  >
        ...
        <div className="text-center">
          <p className="text-xs font-mono text-white/80 tracking-widest animate-pulse">
            START EXPLORING
          </p>
